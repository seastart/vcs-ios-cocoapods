...
extern NSString *const SGGCDAsyncUdpSocketException;
extern NSString *const SGGCDAsyncUdpSocketErrorDomain;

extern NSString *const SGGCDAsyncUdpSocketQueueName;
extern NSString *const SGGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(SGGCDAsyncUdpSocketErrorDomain, SGGCDAsyncUdpSocketError) {
	SGGCDAsyncUdpSocketNoError = 0,          // Never used
	SGGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	SGGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	SGGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	SGGCDAsyncUdpSocketClosedError,          // The socket was closed
	SGGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class SGGCDAsyncUdpSocket;

@protocol SGGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(SGGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(SGGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(SGGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(SGGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(SGGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(SGGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * SGGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^SGGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^SGGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface SGGCDAsyncUdpSocket : NSObject

/**
 * SGGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, SGGCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<SGGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<SGGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<SGGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<SGGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<SGGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<SGGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<SGGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<SGGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means SGGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, SGGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, SGGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, SGGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * 
 * Since the OS/SGGCD notifies us of the size of each received UDP packet,
 ...
 * This is due to the fact that SGGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about SGGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable SGGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable SGGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * SGGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, SGGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about SGGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable SGGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable SGGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The SGGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally SGGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster SGGCD API's.)
