...
@class SGGCDAsyncReadPacket;
@class SGGCDAsyncWritePacket;
@class SGGCDAsyncSocketPreBuffer;
@protocol SGGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const SGGCDAsyncSocketException;
extern NSString *const SGGCDAsyncSocketErrorDomain;

extern NSString *const SGGCDAsyncSocketQueueName;
extern NSString *const SGGCDAsyncSocketThreadName;

extern NSString *const SGGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const SGGCDAsyncSocketUseCFStreamForTLS;
#endif
#define SGGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define SGGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define SGGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const SGGCDAsyncSocketSSLPeerID;
extern NSString *const SGGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const SGGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const SGGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const SGGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const SGGCDAsyncSocketSSLCipherSuites;
extern NSString *const SGGCDAsyncSocketSSLALPN;
#if !TARGET_OS_IPHONE
extern NSString *const SGGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define SGGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(SGGCDAsyncSocketErrorDomain, SGGCDAsyncSocketError) {
	SGGCDAsyncSocketNoError = 0,           // Never used
	SGGCDAsyncSocketBadConfigError,        // Invalid configuration
	SGGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	SGGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	SGGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	SGGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	SGGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	SGGCDAsyncSocketClosedError,           // The remote peer closed the connection
	SGGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface SGGCDAsyncSocket : NSObject

/**
 * SGGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, SGGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<SGGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<SGGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create SGGCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<SGGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq error:(NSError**)error;

+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<SGGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<SGGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<SGGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<SGGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<SGGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<SGGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means SGGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means SGGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, SGGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, SGGCDAsyncSocket will automatically use IPv6.
 ...
 * 
 * Please note the recommended way of releasing a SGGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a SGGCDAsyncSocketReadMaxedOutError.
 ...
 * 
 * - SGGCDAsyncSocketManuallyEvaluateTrust
 ...
 *
 * - SGGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default SGGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct SGGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, SGGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by SGGCDAsyncSocket,
 ...
 *
 * - SGGCDAsyncSocketSSLProtocolVersionMin
 * - SGGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - SGGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - SGGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - SGGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - SGGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see SGGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use SGGCDAsyncSocketSSLProtocolVersionMin & SGGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * SGGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * This is because the SGGCD API offers no mechanism to discover a queue's targetQueue.
 ...
 *   The faster and more powerful SGGCD API isn't notified properly in this case.
 * 
 ...
 * 
 * Note: If the SGGCDAsyncSocket instance is deallocated while it is still connected,
 ...
 * - SGGCDAsyncSocketManuallyEvaluateTrust == YES
 *
