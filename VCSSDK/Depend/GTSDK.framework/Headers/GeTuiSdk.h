...
+ (void)registerRemoteNotification:(UNAuthorizationOptions)types API_AVAILABLE(ios(10.0));
...
- (void)GeTuiSdkDidReceiveNotification:(NSDictionary *)userInfo
                ...
                fetchCompletionHandler:(nullable void (^)(UIBackgroundFetchResult))completionHandler API_AVAILABLE(ios(10.0));


/// 收到透传消息 API_AVAILABLE(ios(10.0))
